...
namespace Fesslersoft.SharedFolderSpy.Controls.Ribbon
{
        ...
        : RibbonTextBox, IContainsRibbonComponents, IDropDownRibbonItem
    {
        ...
        private readonly bool _dropDownVisible;
        ...
        /// <summary>
        ///     Gets or sets the maximum height for the dropdown window.  0 = autosize.  If the size is smaller than the contents
        ///     then scrollbars will be shown.
        /// </summary>
        [DefaultValue(0)]
