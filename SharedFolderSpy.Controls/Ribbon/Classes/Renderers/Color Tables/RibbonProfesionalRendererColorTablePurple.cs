...
{
    public class RibbonProfesionalRendererColorTablePurple
        : RibbonProfesionalRendererColorTable
    {
        public RibbonProfesionalRendererColorTablePurple()
        {
            ...
            Caption1 = FromHex("#BCB1E7");
            Caption2 = FromHex("#C4BBE6");
            Caption3 = FromHex("#B6A9E7");
            Caption4 = FromHex("#AE9FE7");
            Caption5 = FromHex("#B6A9E7");
            Caption6 = FromHex("#C4BBE6");
            Caption7 = FromHex("#BCB1E7");
            ...
            Text = FromHex("#000000");
            RibbonBackground = FromHex("#905EBC");
            TabBorder = FromHex("#C0B4FF");
            TabNorth = FromHex("#C0B4FF");
            TabSouth = FromHex("#ACA1E5");
            TabGlow = FromHex("#D1FBFF");
            TabText = FromHex("#FFFFFF");
            TabActiveText = FromHex("#000000");
            TabContentNorth = FromHex("#C29EE3");
            TabContentSouth = FromHex("#A58BBE");
            TabSelectedGlow = FromHex("#E1D2A5");
            PanelDarkBorder = FromHex("#8241BD");
            PanelLightBorder = FromHex("#E0DCF5");
            PanelTextBackground = FromHex("#ABAEAE");
            PanelTextBackgroundSelected = FromHex("#949495");
            PanelText = FromHex("#FFFFFF");
            PanelBackgroundSelected = FromHex("#CFC3FF");
            ...
            RibbonBackground_2013 = FromHex("#905EBC");
            TabCompleteBackground_2013 = FromHex("#F3F3F3");
            TabNormalBackground_2013 = FromHex("#905EBC");
