...
namespace Fesslersoft.SharedFolderSpy.Controls.Ribbon
{
    ...
    public class RibbonButton : RibbonItem, IContainsRibbonComponents
    {
        ...
        /// </summary>
        [DefaultValue(false), Description("Toggles the Checked property of the button when clicked")]
        ...
        /// </summary>
        /// <remarks>
        ///     When Style is different from SplitDropDown and SplitBottomDropDown, ButtonFaceBounds is the same area than
        ///     DropDownBounds
        /// </remarks>
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public Rectangle ButtonFaceBounds
        {
            get { return _buttonFaceBounds; }
        }
        ...
        {
            var sideBounds = Rectangle.FromLTRB(
        ...
        {
            var theSize = GetNearestSize(e.Mode);
        ...
        public override void SetBounds(Rectangle bounds)
        {
            ...
            var sMode = GetNearestSize(SizeMode);
        ...
        public void ShowDropDown()
        {
            ...
            var canvasdd = Canvas as RibbonPopup;
            var location = OnGetDropDownMenuLocation();
            var minsize = OnGetDropDownMenuSize();
        ...
        public override void OnMouseMove(MouseEventArgs e)
        {
            ...
            if (Style == RibbonButtonStyle.SplitDropDown)
            {
                var lastState = _dropDownSelected;
