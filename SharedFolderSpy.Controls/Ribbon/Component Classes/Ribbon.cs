...
namespace Fesslersoft.SharedFolderSpy.Controls.Ribbon
{
        ...
        : Control
    {
        ...
        private readonly RibbonCaptionButton _CloseButton;
        private readonly RibbonCaptionButton _MaximizeRestoreButton;
        private readonly RibbonCaptionButton _MinimizeButton;
        private readonly RibbonContextCollection _contexts;
        private readonly RibbonOrbDropDown _orbDropDown;
        private readonly RibbonQuickAccessToolbar _quickAcessToolbar;
        ...
        public int MinimizedHeight
        {
            get
            {
                var tabBottom = Tabs.Count > 0 ? Tabs[0].Bounds.Bottom : 0;
        ...
        internal Rectangle CaptionTextBounds
        {
            get
            {
                if (RightToLeft == RightToLeft.No)
                {
                    ...
                    var r = Rectangle.FromLTRB(left, 0, Width - 100, CaptionBarSize);
                    return r;
                }
                else
                {
                    ...
                    var r = Rectangle.FromLTRB(100, 0, right, CaptionBarSize);
                    return r;
                }
            }
        }
        ...
        public Rectangle OrbBounds
        {
            get
            {
                ...
                if (OrbStyle == RibbonOrbStyle.Office_2010) //Kevin Carbis - office 2010 style orb
                {
                    ...
                    var contentSize = TextRenderer.MeasureText(OrbText, RibbonTabFont);
        ...
        /// </summary>
        [DefaultValue(DefaultPanelSpacing), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        {
            get { return _tabsPadding; }
            set { _tabsPadding = value; }
        }
        ...
        {
            get { return _orbsPadding; }
            set { _orbsPadding = value; }
        }
        ...
        {
            get { return new Size(0, 200); //115 was the old one
            }
            set
            {
                //not supported
        ...
        private string cr
        {
            get { return "Professional Ribbon\n\n2009 Jos?Manuel Menéndez Poo\nwww.menendezpoo.com"; }
        }
        ...
        {
            var trigger = _actualBorderMode != borderMode;
        ...
        {
            var trigger = _CaptionButtonsVisible != visible;
        ...
        internal void UpdateRegions(Graphics g)
        {
            ...
            if (RightToLeft == RightToLeft.No)
            {
                ...
                var curLeft = TabsMargin.Left + OrbBounds.Width;
                ...
                foreach (var tab in Tabs)
                {
                    if (tab.Visible || IsDesignMode())
                    {
                        ...
                        var bounds = new Rectangle(curLeft, TabsMargin.Top,
            ...
            {
                ///X coordinate reminder
                var curRight = OrbBounds.Left - TabsMargin.Left + 4;
                ...
                foreach (var tab in Tabs)
                {
                    if (tab.Visible || IsDesignMode())
                    {
                        ...
                        var bounds = new Rectangle(curRight, TabsMargin.Top,
                            TabsPadding.Left + tabSize.Width + TabsPadding.Right,
                            TabsPadding.Top + tabSize.Height + TabsPadding.Bottom);
                ...
                if (OrbStyle == RibbonOrbStyle.Office_2007)
                    ...
                    QuickAcessToolbar.SetBounds(new Rectangle(new Point(ClientRectangle.Right - QuickAcessToolbar.Margin.Right - QuickAcessToolbar.LastMeasuredSize.Width, 0), QuickAcessToolbar.LastMeasuredSize));
                else if (OrbStyle == RibbonOrbStyle.Office_2013) //Michael Spradlin - 05/03/2013 Office 2013 Style Changes: no need to offset for the orb
                    QuickAcessToolbar.SetBounds(new Rectangle(new Point(ClientRectangle.Right - QuickAcessToolbar.Margin.Right - QuickAcessToolbar.LastMeasuredSize.Width, 0), QuickAcessToolbar.LastMeasuredSize));
        ...
        protected override void WndProc(ref Message m)
        {
            ...
            if (WinApi.IsWindows && (ActualBorderMode == RibbonWindowMode.NonClientAreaGlass || ActualBorderMode == RibbonWindowMode.NonClientAreaCustomDrawn))
            {
                if (m.Msg == WinApi.WM_NCHITTEST) //0x84
                {
                    ...
                    if (RightToLeft == RightToLeft.No)
                    {
                        var captionLeft = QuickAcessToolbar.Visible ? QuickAcessToolbar.Bounds.Right : OrbBounds.Right;
                    ...
                    {
                        var captionRight = QuickAcessToolbar.Visible ? QuickAcessToolbar.Bounds.Left : OrbBounds.Left;
                    ...
                    var ribbonPoint = PointToClient(screenPoint);
                    ...
                    if (RectangleToScreen(caption).Contains(screenPoint) && !onCaptionButtons)
                    {
                        ...
                        var p = PointToScreen(screenPoint);
