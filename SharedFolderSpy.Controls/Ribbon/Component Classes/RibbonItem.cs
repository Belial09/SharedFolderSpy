...
namespace Fesslersoft.SharedFolderSpy.Controls.Ribbon
{
    ...
    public abstract class RibbonItem : Component, IRibbonElement, IRibbonToolTip
    {
        ...
        {
            var dd = Canvas as RibbonDropDown;
        ...
        public virtual bool Checked
        {
            ...
            set
            {
                ...
                if (value)
                {
                    ...
                    {
                        foreach (var itm in ((RibbonDropDown) Canvas).Items)
                        {
                        ...
                        foreach (var itm in _ownerPanel.Items)
                        {
                            if (itm.CheckedGroup == _checkedGroup && itm.Checked && itm != this)
                            {
                                itm.Checked = false;
        ...
        /// <summary>
        ///     Determins the other Ribbon Items that belong to this checked group.  When one button is checked the other items in
        ///     this group will be unchecked automatically.  This only applies to Items that are within the same Ribbon Panel or
        ///     Dropdown Window.
        /// </summary>
        /// <remarks></remarks>
        [DefaultValue(null)]
        ...
        {
            get { return _checkedGroup; }
            set { _checkedGroup = value; }
        }
        ...
        protected RibbonElementSizeMode GetNearestSize(RibbonElementSizeMode sizeMode)
        {
            ...
            var max = (int) MaxSizeMode;
            var min = (int) MinSizeMode;
